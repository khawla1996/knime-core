...
import org.knime.core.data.predicate.FilterPredicate.Visitor;
...
import org.knime.core.data.predicate.IndexedColumn.LongColumn;
import org.knime.core.data.predicate.IndexedColumn.StringColumn;
 ...
 * @since 3.8
 */
public class FilterPredicateValidator implements Visitor<Void> {
    ...
    /**
     * Types have to be equal! Checking whether types are compatible is not sufficient; It allows e.g., a column of type
     * DurationCell.TYPE to be declared as StringColumn. The predicate won't work with Parquet and therefore does not do
     * us any good.
     */
    private static final class ColumnValidator implements org.knime.core.data.predicate.Column.Visitor<Void> {

        private final DataTableSpec m_spec;

        public ColumnValidator(final DataTableSpec spec) {
            m_spec = spec;
        }
